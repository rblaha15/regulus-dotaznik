...
val SkStrings = object : Strings {
    ...
    override val contacts = object : ContactsStrings {
        ...
        override val demandSubject = "Predmet dopytu"
    ...
    override val fve = object : FVEStrings {
        override val fve = "FVE"
        override val currentSituation = "Súčasný stav"
        override val currentHeating = "Súčasný zdroj vykurovania"
        override val currentHotWater = "Súčasný zdroj prípravy teplej vody"
        override val currentTanks = "Inštalované nádrže/zásobníky"
        override val currentConsumption = "Aktuálna ročná spotreba el. energie"
        override val breakerSize = "Veľkosť hlavného ističa"
        override val tariff = "Sadzba"
        override val breakerBoxLocation = "Umiestnenie domového rozvádzača"
        override val requirements = "Požiadavky na FVE"
        override val requiredPower = "Požadovaný výkon"
        override val locationBuidingType = "Typ budovy na inštaláciu kolektorov"
        override val lightningRod = "Na streche pre inštaláciu je umiestnený bleskozvod"
        override val familyHouseEtc = "Rodinný dom, stodola, pergola, …"
        override val avaiableAreas = "Dostupné plochy pre inštaláciu"
        override val roofMaterial = "Materiál stresnej krytiny"
        override val roofAge = "Vek strešnej krytiny"
        override val tile = "Taška"
        override val tileType = "Typ tašiek"
        override val metalSheetFolded = "Plech falcovaný"
        override val metalSheetTrapezoidal = "Plech trapézový"
        override val foil = "Fólia"
        override val asphaltShingle = "Asfaltový šindeľ"
        override val useOptimizers = "Použiť optimizéry"
        override val size = { i: Int -> "Rozmer $i. plochy" }
        override val orientation = { i: Int -> "Orientácia $i. plochy" }
        override val slope = { i: Int -> "Sklon $i. plochy" }
        override val battery = "Akumulácia do batérií"
        override val batteryCapacity = "Kapacita batérií"
        override val water = "Akumulácia do vody"
        override val network = "Pretoky do siete"
        override val networkPower = "Pretoky do siete – rezervovaný výkon"
        override val charging = "Dobíjacia stanica – wallbox"
    }
